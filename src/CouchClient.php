...
class CouchClient extends Couch
{
    ...
    protected $queryDefs = [
        ...
        'bookmark' => ['name' => 'bookmark', 'filter' => 'string'],
    ...
    private function _find($endpoint, $selector, $index = null)
    {
        ...
        //Parameter validation
        $fieldsToParse = ['fields', 'limit', 'skip', 'bookmark'];
